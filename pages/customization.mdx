...
use-cardano allows you to easily overwrite the default styles of its components. This is simply done with vanilla CSS, with a small set of classes, using BEM naming conventions.
